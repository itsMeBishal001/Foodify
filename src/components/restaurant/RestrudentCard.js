...
const RestrudentCard = ({
  ...
  return (
    <div className="p-4 flex flex-col space-y-2 font-sans">
      {promoted && (
        <span className="text-secondary bg-secondary-light px-2 py-1 rounded font-bold inline-block">
          Promoted
        </span>
      )}
      ...
      <div className="flex flex-col space-y-1">
        <h3 className="text-xl font-bold whitespace-nowrap overflow-hidden overflow-ellipsis text-gray-800">{name}</h3>
